...
class RabbtMQService
{
    ...
    {
        $this->configs = [
            'host' => config('standapi.rabbitmq_host'),
            'port' => config('standapi.rabbitmq_port'),
            'login' => config('standapi.rabbitmq_login'),
            'password' => config('standapi.rabbitmq_password'),
            'vhost' => config('standapi.rabbitmq_vhost')
        ];
